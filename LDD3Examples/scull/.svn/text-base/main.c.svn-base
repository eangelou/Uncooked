...
/*
 * file 結構代表已開啟的檔案。系統上每一個已開啟的檔案，在 kernel space 裡都有
 * 一個對應的 file 結構。
 *
 * inode 結構代表已開啟的檔案的 FD。當同一個檔案被開啟多次，核心中會有多個代表
 * FD 的 file 結構，但它們都指向同一個 inode。
 */
...
int scull_init_module(void)
{
	...
	for (i = 0; i < Scull_nr_devs; i++) {
		...
		// Mutex changed to semaphore in newer kernels
#ifndef init_MUTEX
